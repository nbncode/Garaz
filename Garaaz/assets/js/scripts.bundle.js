...
var KTLayout = function () {
    ...
    return {
        ...
        bindMenu: function () {
            ...
            $("#kt_aside_menu ul > li").each(function () {
                var cur = $(this);
                if (isActiveItem(cur)) {                    
                    cur.addClass("kt-menu__item--active");
                }
            });

            $("#kt_aside_menu ul > li .kt-menu__submenu").each(function () {
                var cur = $(this);
                ...
                for (var i = 0; i < childrenlsits.length; i++) {
                    ...
                    if (isActiveItem(menuitem)) {
                        cur.show();
                        menuitem.addClass("kt-menu__item--active");
                        cur.parent("li").addClass("kt-menu__item--active");
                    }
                }
            });
        },
